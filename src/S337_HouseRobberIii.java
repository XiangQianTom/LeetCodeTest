...
public class S337_HouseRobberIii {
    /**
    ...
    public static void main(String[] args) {
        Solution solution = new S337_HouseRobberIii().new Solution();
    }
    ...
    class Solution {
        ...
        private void dfs(TreeNode treeNode) {
            ...
            l.put(treeNode,
                    treeNode.val
                            + r.getOrDefault(treeNode.left, 0)
                            + r.getOrDefault(treeNode.right, 0));
            r.put(treeNode,
                    Math.max(
                            l.getOrDefault(treeNode.left, 0),
                            r.getOrDefault(treeNode.left, 0))
                            + Math.max(
                            l.getOrDefault(treeNode.right, 0),
                            r.getOrDefault(treeNode.right, 0)));
        }
    }
}