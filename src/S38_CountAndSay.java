public class S38_CountAndSay {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.countAndSay(6));//"312211"
        System.out.println(solution.countAndSay(7));//"13112221"
    }
    ...
    static class Solution {
            ...
            for (int i = 0; i < n - 1; i++) {
                ...
                for (int j = 1; j < chars.length; j++) {
                    if (lastChar == chars[j]) {
                        ...
                        newStr.append(length).append(lastChar);
                        length = 1;
                        lastChar = chars[j];
                    }
                }
        ...
        public String countAndSay(int n) {
            StringBuilder newStr = new StringBuilder();
            return countAndSay("1", newStr, n);
        }

        private String countAndSay(String lastStr, StringBuilder newStr, int n) {
            if (n == 1) {
                return lastStr;
            }
            char[] chars = lastStr.toCharArray();
            ...
            lastStr = newStr.toString();
            newStr.delete(0, newStr.length());
            return countAndSay(lastStr, newStr, --n);
        }
    }
}